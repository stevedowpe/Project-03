...
Plotly.d3.csv("output/SDCCD-Equipment-DataBuild-11220-CSI22.csv", function (error, response) {
  ...
  var myPlot = document.getElementById('plot_EqWarranty_bar_22');
  ...
  Plotly.newPlot("plot_EqWarranty_bar_22", data_EqWarranty, layout_EqWarranty);
  ...
  myPlot.on('plotly_click', function (data) {
    ...
    document.getElementById("populating_table_EqWarranty_22").innerHTML = table_alert;
  })
