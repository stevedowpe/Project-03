...
Plotly.d3.csv("output/SDCCD-Equipment-DataBuild-11220-CSI23.csv", function (error, response) {
  ...
  var myPlot = document.getElementById('plot_OM_bar_23');
  ...
  Plotly.newPlot("plot_OM_bar_23", data_OM, layout_OM);
  ...
  myPlot.on('plotly_click', function (data) {
    ...
    document.getElementById("populating_table_OM_23").innerHTML = table_alert;
  })
