...
Plotly.d3.csv("output/SDCCD-Equipment-DataBuild-11220-CSI22.csv", function (error, response) {
  ...
  var myPlot = document.getElementById('plot_Submittal_bar_22');
  ...
  Plotly.newPlot("plot_Submittal_bar_22", data_Submittal, layout_Submittal);
  ...
  myPlot.on('plotly_click', function (data) {
    ...
    document.getElementById("populating_table_Submittal_22").innerHTML = table_alert;
  })
