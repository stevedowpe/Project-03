...
Plotly.d3.csv("output/SDCCD-Program-Close-Data.csv", function (error, response) {
  ...
  console.log('BIM Project Number, OK: ', ProjectNumber_ok )
  console.log('BIM Comments, OK: ', BIMComments_ok )
  ...
  myPlot.on('plotly_click', function (data) {
    ...
    table_alert += "<th>Proj#_ </th>" + "<th>Project Name</th>"+"<th>Comments</th>"
