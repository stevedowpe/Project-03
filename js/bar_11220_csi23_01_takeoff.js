...
Plotly.d3.csv("output/SDCCD-Equipment-DataBuild-11220-CSI23.csv", function (error, response) {
  ...
  var myPlot = document.getElementById('plot_Takeoff_bar_23');
  ...
  Plotly.newPlot("plot_Takeoff_bar_23", data_Takeoff, layout_Takeoff);
  ...
  myPlot.on('plotly_click', function (data) {
    ...
    document.getElementById("populating_table_Takeoff_23").innerHTML = table_alert;
  })
